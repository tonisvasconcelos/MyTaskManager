  ...
  const expenseData = [
    {
      ...
      refStartDate: new Date('2024-01-01'),
      refEndDate: new Date('2024-01-31'),
    ...
    },
    {
      ...
      refStartDate: new Date('2024-02-01'),
      refEndDate: new Date('2024-02-29'),
      invoiceCurrencyCode: 'USD',
      totalAmount: 450.00,
      paymentMethod: PaymentMethod.CORPORATE_CREDIT_CARD,
      status: PaymentStatus.PAID,
  ...
  for (const expenseInfo of expenseData) {
    const expense = await prisma.expense.create({
      data: {
        ...
        dueDate: expenseInfo.dueDate || null,
        refStartDate: expenseInfo.refStartDate || null,
        refEndDate: expenseInfo.refEndDate || null,
        invoiceCurrencyCode: expenseInfo.invoiceCurrencyCode || null,
